<form id="filtro" class="m-b-15">
    <div class="form-body">
        ...
        <div class="row">
            <div class="col-12 col-md-1" style="min-width: 220px">
            ...
            <div class="col-12 col-md-1" style="min-width: 220px">
                <div class="form-group">
                    ...
                    <select id="cod" name="cod" class="form-control" style="min-width: 200px" autocomplete="off">
                        <option value="TD">Todos</option>
                        <option value="AT">Atestado</option>
                        <option value="CO">Covid</option>
                        <option value="AT,CO">Atestado e Covid</option>
                    </select>
                </div>
            </div>
        </div>
