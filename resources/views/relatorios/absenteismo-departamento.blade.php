...
<div class="container-fluid">
    <div class="white-box">
        ...
        <h3 class="font-bold">TABELA DE INDICADORES DE ABSENTEÍSMO POR DIA E POR DEPARTAMENTO</h3>
        <div class="table-responsive">
            <table class="table table-bordered table-condensed">
                ...
                <tbody class="text-center text-nowrap">
                    @foreach($resultados as $departamento => $resultado)
                        <tr>
                            <td>{{$departamento}}</td>
        ...
        <div class="col-xs-12">
            <div class="white-box">
                <h3 class="box-title">GRÁFICO DE INDICADORES DE ABSENTEÍSMO POR DIA E POR DEPARTAMENTO <small>Passe o mouse para ver os detalhes</small></h3>
...
<script>
    ...
    var newUrl = function newUrl(hospitais,tipo,inicial,final) {
        ...
        var url = '/relatorios/absenteismo-departamento?' + jQuery.param(params);
...
<script>
        ...
        let departamentos = JSON.parse('{!! json_encode($departamentos) !!}');
