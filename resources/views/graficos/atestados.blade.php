                ...
                <table id="resultado" class="table table-bordered table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center font-12 p-3 background-yellow">Total de colegas ativos mês</th>
                            ...
                            <th class="text-center font-12 p-3 background-yellow">% de atestados por Colegas</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
